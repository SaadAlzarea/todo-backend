 ...
 */
export declare abstract class AbstractValidator<S extends TSchema> {
     ...
     *  parameter provides the exception's overall error message.
     */
    abstract assertAndCleanCopy(value: Readonly<unknown>, errorMessage?: string): Static<S>;
    /**
     ...
     *  parameter provides the exception's overall error message.
     */
    abstract validateAndCleanCopy(value: Readonly<unknown>, errorMessage?: string): Static<S>;
    /**
    ...
    protected cleanCopyOfValue<VS extends TSchema>(schema: Readonly<VS>, value: Readonly<unknown>): Static<VS>;
    protected cleanValue<VS extends TSchema>(schema: Readonly<VS>, value: unknown): void;
    protected uncompiledAssert(schema: Readonly<TSchema>, value: Readonly<unknown>, overallError?: string): void;
    protected uncompiledValidate(schema: Readonly<TSchema>, value: Readonly<unknown>, overallError?: string): void;
}
//# sourceMappingURL=abstract-validator.d.ts.map